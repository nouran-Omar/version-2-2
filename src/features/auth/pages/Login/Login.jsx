  ...
  >
    Remember me
            ...
            <button
              ...
              className="w-full bg-brand-main cursor-pointer hover:bg-brand-dark text-white font-semibold py-3.5 rounded-full flex items-center justify-center gap-2 transition-all shadow-md active:scale-[0.98] disabled:bg-gray-300"
            >
