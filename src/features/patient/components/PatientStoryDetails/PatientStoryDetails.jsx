      ...
      <div className="w-full flex flex-col gap-5 p-[24px] ">
        {/* ── Page Header ── */}
           <div>  <div className="flex items-center gap-2 mb-1">
            ...
            <h1 className="text-2xl font-bold text-black-main-text">Patient Story Details</h1>
          </div>
          <p className="text-lg text-[#757575]">Read full patient journey and shared experiences.</p>
</div>
        ...
        <div className="bg-white rounded-2xl p-5 sm:p-7 border border-gray-100 shadow-sm">
          <h2 className="text-3xl sm:text-3xl font-bold text-black-main-text mb-5">{story.title}</h2>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-3 gap-4">
            {RELATED.map((r) => (
              <div key={r.id} className="bg-white rounded-2xl p-4 border border-gray-100 shadow-sm flex flex-col gap-3">
                ...
                <button onClick={() => navigate(`/patient/stories/${r.id}`)} className="cursor-pointer text-xs font-semibold text-brand-main hover:underline text-left mt-auto">
                  Read Story →
                </button>
              </div>
            ))}
        ...
        <div className="flex justify-end gap-3 py-2">
          ...
          <button onClick={() => navigate('/patient/write-story')} className="flex cursor-pointer items-center gap-1.5 px-6 py-2.5 rounded-full bg-brand-main text-white text-sm font-semibold hover:bg-[#2730d4] transition">
