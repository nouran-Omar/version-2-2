...
const PatientQRCode = () => {
 ...
 <header className="flex flex-col pb-4 ">
  ...
  <p className=" text-[18px] ml-2 text-[#757575]  max-w-2xl">
    Access all your medical records instantly by scanning this code.
      ...
      {/* Main Grid */}
      <div className=" grid grid-cols-1  mb-40  lg:grid-cols-2 gap-6">
        {/* QR Card */}
        <div className="bg-white w-96 rounded-[22px] border border-gray-100 shadow-sm p-6 flex flex-col items-center gap-5">
          ...
          <button
            className="w-full bg-brand-main cursor-pointer hover:bg-[#2830d4] text-white font-bold rounded-full py-2.5 text-[13px] transition-colors"
            onClick={downloadPDF}
          >
            Download PDF
          </button>
        ...
        <div className="flex flex-col gap-4 w-90">
          {/* What's inside */}
          <div className="bg-white rounded-[22px] w-80 border border-gray-100 shadow-sm p-5">
          ...
          >
            <div className="flex items-center w-85 gap-2">
              <HiOutlineLightBulb className="text-[#FFC500] text-xl" />
