...
export default function PatientSettingsProfile() {
  ...
  /* â”€â”€ render â”€â”€ */
  return (
    <div className="flex flex-col gap-6 font-roboto p-[24px] ">
...
<header className="flex flex-col  pb-4 ">
  ...
  <p className="text-[18px]  text-gray-text-dim2 cursor-pointer ml-2 ">
        ...
        <div className="p-6">
          ...
          <div className="flex justify-end mt-6">
            <button
              ...
              className="bg-brand-main cursor-pointer hover:bg-blue-700 text-white px-7 py-3 rounded-xl font-bold flex items-center gap-2 transition-colors text-sm"
            >
      ...
      <div className="bg-white rounded-[22px] border border-[#E5E7EB] shadow-sm overflow-hidden">
        ...
        <div className="p-6">
          ...
          <button
            ...
            className="border border-brand-main cursor-pointer text-brand-main hover:bg-[#EEF2FF] transition-colors px-6 py-2.5 rounded-full text-sm font-bold"
          >
            Update Health Data
          </button>
        </div>
