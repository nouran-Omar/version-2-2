...
const Sidebar = ({ onClose, onLogout }) => {
  ...
  return (
    /* أضفنا group للتحكم في ظهور السكرول عند الهوفر */
    <div className="group flex flex-col h-full bg-white rounded-[24px] overflow-hidden border border-gray-100/50 shadow-sm">
      ...
      <div className="flex items-center gap-2 px-4 py-3 shrink-0">
        ...
        <span className="text-[13px] font-bold text-black-main-text tracking-tight uppercase">
          Pulse<span className="text-[#333CF5]">X</span> Admin
        </span>
      </div>
