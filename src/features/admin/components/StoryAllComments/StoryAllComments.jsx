        ...
        {comments.length === 0 ? (
          ...
          comments.map(comment => (
            <li key={comment.id} className={`rounded-[14px] border  p-4   rounded-2xl overflow-hidden transition-all ${comment.flagged ? 'border-[#FFA2A2] bg-white' : 'border-[#E5E7EB] bg-white'}`}>
              ...
              {/* Flagged Banner */}
              {comment.flagged && (
                <div className="flex items-center gap-2 px-4 py-2 bg-[#FFE2E2] text-[#C10007] text-[14px] font-semibold border rounded-2xl border-[#FFA2A2]">
              ...
              <div className="flex items-start gap-3 p-4">
                ...
                <div className="flex-1 min-w-0 flex flex-col gap-1.5 p-2 border-none rounded-2xl">
                  ...
                  {/* Time */}
                  <div className="flex items-center gap-1 text-[14px] text-[#6A7282]">
                    <span>📅</span>
                    {comment.time}
                  </div>
